      ...
      <main>
        <div className="nft-main">
          ...
          <header className="nft-main__header">
            ...
            <button className="nft-main__header__button">Connect Wallet</button>
            <div
              onClick={() => (active ? setActive(false) : setActive(true))}
              className={!active ? "nft-main__header__hamburger" : "nft-main__header__hamburger nft-main__header__hamburger-active"}
            >
            ...
            <div className={active ? "nft-main__header__sidebar" : "nft-main__header__sidebar nft-main__header__sidebar-none"}>
            <div>Explore</div>
              <div>Activity</div>
              <div>Community</div>
              <div>How it works</div>

              <button className="nft-main__header__sidebar__button">Connect Wallet</button>
            </div>
          </header>
          <div className="nft-main__hero">
            <div className="nft-main__hero__title">
              EXPLORE THE BEST NFT <br />
              MARKETPLACE
            </div>
            <div className="nft-main__hero__subtitle">
              Discover the Top NFT Marketplaces for Buying and Selling Unique
              Digital Assets and Unlock the Power of Digital Ownership with Your
              Guide to the Hottest Trends.
            </div>
            <div className="nft-main__hero__button-group">
        ...
        <div className="explore">
          <div className="explore__card1">
            ...
            <div className="explore__card1__subtitle">
              We can help you buy sell and discover new and rare digital items.
            </div>
          </div>
        ...
        <div className="exploreMain">
          ...
          <div className="exploreMain__nav">
            ...
            <div
              className={activeNav === "domains" && "exploreMain__nav__active"}
